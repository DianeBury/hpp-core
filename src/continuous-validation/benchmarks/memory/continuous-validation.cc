...
namespace hpp {
  namespace core {
    namespace memory {
      ...
      using continuousValidation::memory::SolidSolidCollision;
      using continuousValidation::memory::BodyPairCollisionPtr_t;
      using continuousValidation::memory::BodyPairCollision;
      ...
      void ContinuousValidation::Initialize::doExecute() const
      {
        ...
        for (std::size_t i = 0; i < gmodel.collisionPairs.size(); ++i)
        {
          ...
          if (_bp == bodyPairMap.end())
          {
            ...
            assert(joint2);
            continuousValidation::memory::SolidSolidCollisionPtr_t ss
