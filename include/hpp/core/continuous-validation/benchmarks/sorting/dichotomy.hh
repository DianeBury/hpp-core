...
#ifndef HPP_CORE_CONTINUOUS_VALIDATION_SORTING_DICHOTOMY_HH
# define HPP_CORE_CONTINUOUS_VALIDATION_SORTING_DICHOTOMY_HH
...
namespace hpp {
  namespace core {
    namespace continuousValidation {
      namespace sorting {
        using hpp::core::sorting::ContinuousValidation;
        ...
        /// for details.
        class HPP_CORE_DLLAPI Dichotomy : public hpp::core::sorting::ContinuousValidation
        {
        public:
