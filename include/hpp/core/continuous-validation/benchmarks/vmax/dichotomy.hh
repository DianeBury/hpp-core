...
#ifndef HPP_CORE_CONTINUOUS_VALIDATION_VMAX_DICHOTOMY_HH
# define HPP_CORE_CONTINUOUS_VALIDATION_VMAX_DICHOTOMY_HH
...
namespace hpp {
  namespace core {
    namespace continuousValidation {
      namespace vmax {
        using hpp::core::vmax::ContinuousValidation;
        ...
        /// for details.
        class HPP_CORE_DLLAPI Dichotomy : public hpp::core::vmax::ContinuousValidation
        {
        public:
