...
#ifndef HPP_CORE_CONTINUOUS_VALIDATION_MEMORY_DICHOTOMY_HH
# define HPP_CORE_CONTINUOUS_VALIDATION_MEMORY_DICHOTOMY_HH

# include <hpp/core/continuous-validation/benchmarks/memory/continuous-validation.hh>

namespace hpp {
  namespace core {
    namespace continuousValidation {
      namespace memory {
        using hpp::core::memory::ContinuousValidation;
        ...
        /// for details.
        class HPP_CORE_DLLAPI Dichotomy : public hpp::core::memory::ContinuousValidation
        {
        public:
