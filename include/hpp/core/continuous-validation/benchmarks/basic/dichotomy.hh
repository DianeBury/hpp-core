...
#ifndef HPP_CORE_CONTINUOUS_VALIDATION_BASIC_DICHOTOMY_HH
# define HPP_CORE_CONTINUOUS_VALIDATION_BASIC_DICHOTOMY_HH
...
namespace hpp {
  namespace core {
    namespace continuousValidation {
      namespace basic {
        using hpp::core::basic::ContinuousValidation;
        ...
        /// for details.
        class HPP_CORE_DLLAPI Dichotomy : public hpp::core::basic::ContinuousValidation
        {
        public:
