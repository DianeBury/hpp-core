...
#include <hpp/core/continuous-validation/benchmarks/sorting/continuous-validation.hh>
...
#include <hpp/core/continuous-validation/benchmarks/sorting/solid-solid-collision.hh>
...
namespace hpp {
  namespace core {
    namespace sorting {
      ...
      using continuousValidation::sorting::SolidSolidCollision;
      using continuousValidation::sorting::BodyPairCollisionPtr_t;
      using continuousValidation::sorting::BodyPairCollision;
      ...
      void ContinuousValidation::Initialize::doExecute() const
      {
        ...
        for (std::size_t i = 0; i < gmodel.collisionPairs.size(); ++i)
        {
          ...
          if (_bp == bodyPairMap.end())
          {
            ...
            assert(joint2);
            continuousValidation::sorting::SolidSolidCollisionPtr_t ss
      ...
      {
        hppDout(benchmark, "Sorting new path");
