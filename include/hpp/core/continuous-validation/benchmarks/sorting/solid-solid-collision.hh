...
#ifndef HPP_CORE_CONTINUOUS_VALIDATION_SORTING_SOLID_SOLID_COLLISION_HH
# define HPP_CORE_CONTINUOUS_VALIDATION_SORTING_SOLID_SOLID_COLLISION_HH

#include <hpp/core/continuous-validation/benchmarks/sorting/body-pair-collision.hh>
