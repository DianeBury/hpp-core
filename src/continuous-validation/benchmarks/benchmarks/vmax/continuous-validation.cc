...
namespace hpp {
  namespace core {
    namespace vmax {
      ...
      using continuousValidation::vmax::SolidSolidCollision;
      using continuousValidation::vmax::BodyPairCollisionPtr_t;
      using continuousValidation::vmax::BodyPairCollision;
      ...
      void ContinuousValidation::Initialize::doExecute() const
      {
        ...
        for (std::size_t i = 0; i < gmodel.collisionPairs.size(); ++i)
        {
          ...
          if (_bp == bodyPairMap.end())
          {
            ...
            assert(joint2);
            continuousValidation::vmax::SolidSolidCollisionPtr_t ss
      ...
      {
        hppDout(benchmark, "Vmax new path");
