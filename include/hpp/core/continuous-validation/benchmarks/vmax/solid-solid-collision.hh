...
#ifndef HPP_CORE_CONTINUOUS_VALIDATION_VMAX_SOLID_SOLID_COLLISION_HH
# define HPP_CORE_CONTINUOUS_VALIDATION_VMAX_SOLID_SOLID_COLLISION_HH

#include <hpp/core/continuous-validation/benchmarks/vmax/body-pair-collision.hh>
